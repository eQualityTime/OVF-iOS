...
//// Download pageset json file from server to populate core data
//+(void)download:(void (^)(BOOL success)) completionHandler error: (void (^)(NSError *error)) errorHandler{
//    NSURL *pageSetJSON = [NSURL URLWithString:[NSString stringWithFormat:@"%@%@%@",kHost,kResourceFolder,kPageSetJSON ]];
//    [GridManager getJSON: pageSetJSON completion: ^(NSDictionary * _Nonnull data) {
//
//        NSDictionary *grids = [GridManager parseRemoteData: data];
//        [GridManager saveJSON: grids
